...
function FieldInsetProfile({elm, project, classes, elm_type, onClick, disabled, ...props}) {
  ...
  const list = React.useMemo(() =>
    sys.inserts(elm_type || elm.elm_type, false, elayer ? elm : {layer, project, ox: project.ox}), [elm, layer, elm_type]);
