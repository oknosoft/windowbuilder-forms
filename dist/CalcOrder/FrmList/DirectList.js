...
var _ref2 = /*#__PURE__*/React.createElement(LoadingMessage, {
  text: "Чтение индекса документов..."
});

var _ref3 = /*#__PURE__*/React.createElement(LoadingMessage, {
  text: "Чтение настроек компоновки..."
});

var _ref4 = /*#__PURE__*/React.createElement(LoadingMessage, {
  text: "Ошибка настроек компоновки..."
});

var _ref5 = /*#__PURE__*/React.createElement("meta", {
  name: "description",
  content: "Форма списка"
});

var _ref6 = /*#__PURE__*/React.createElement("meta", {
...
class DirectList extends MDNRComponent {
  constructor(props, context) {
    ...
    this.loadMoreRows = ({
      ...
      return Promise.resolve().then(() => {
        ...
        this.setState(newState); // фильтруем в озу
        ...
        scheme.selection.find_rows({
          ...
          switch (srow.comparison_type) {
            ...
            case ct.nin:
            case ct.ninh:
              selector[srow.left_value] = {
                [srow.comparison_type.valueOf()]: srow.right_value.split(',')
              };
              break;
        ...
        selector._raw = true;
        return Promise.resolve($p.utils._find_rows_with_sort.call(_mgr, _mgr.alatable, selector)).then(({
          docs,
          scroll,
          count
        }) => {
    ...
    this.handlePrint = model => {
      ...
      if (!row) {
        $p.ui.dialogs.alert({
          text: 'Укажите строку для печати',
          title: _meta.synonym
        });
  ...
  handleManagerChange({
    ...
    this.setState(newState);
    (_mgr.direct_load ? _mgr.direct_load() : Promise.resolve()).then(() => scheme || $p.cat.scheme_settings.get_scheme(class_name)).then(this.handleSchemeChange);
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", null, !context.dnr && /*#__PURE__*/React.createElement(Helmet, {
      key: "helmet",
      title: title
    }, _ref5, /*#__PURE__*/React.createElement("meta", {
      property: "og:title",
      content: title
    }), _ref6), // диалог предупреждений при удалении
